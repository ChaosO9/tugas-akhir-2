...
export default async function dapatkanDataKunjunganRawatInap(): Promise<
    KunjunganRawatInap[] | AppError
> {
    try {
        const result = await db.query(
            `
                ...
                WHERE
                    ...
                    AND to_char( t_pendaftaran.pendaftaran_mrs, 'DD-MM-YYYY HH24:MM:SS' ) >= '02-06-2024 00:00:00' 
                    AND to_char( t_pendaftaran.pendaftaran_mrs, 'DD-MM-YYYY HH24:MM:SS' ) <= '09-06-2024 08:00:00' 
                ORDER BY
        ...
        return new AppError(`Error fetching kunjungan rawat inap data`, 500);
    }
}
